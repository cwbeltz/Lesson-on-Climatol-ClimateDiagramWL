...
```{r}
Vancouver_data$year.yday <- paste(Vancouver_data$year, Vancouver_data$yday, sep="-")

Vancouver_data$month <- month(as.POSIXlt(Vancouver_data$year.yday, format="%Y-%j"), label=TRUE)
```
