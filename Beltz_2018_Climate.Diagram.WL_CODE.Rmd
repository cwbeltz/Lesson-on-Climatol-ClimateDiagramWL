...
Condense data to 30-yr monthly climate normals:
...
```{r}
loc.elev <- data.frame(Loc=unique(Ex4.orig$Name), elev=unique(tmp.orig$Elevation..m.)) #create file with location name and elevation to reference later
